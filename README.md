...
- 默认导出 v2.1 长表 CSV/XLSX；XLSX 固定包含 `Data`、`Plots`、`Project` 三个 sheet。
- ZIP 固定包含 canonical CSV/XLSX、逐图 XLSX、截图、PPT 摘要和 manifest。
...
7. 导出 v2.1 CSV/XLSX，或生成包含 canonical 数据、逐图工作簿、截图和 PPT 摘要的 ZIP。
